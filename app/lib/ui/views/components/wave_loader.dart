...
class LoadingScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      color: const Color.fromRGBO(201, 217, 207, 1),
      child: const Center(
        child: WaveDots(size: 70.0, color: primaryColor),
      ),
    );
  }
}
...
class WaveDotsState extends State<WaveDots> with SingleTickerProviderStateMixin {
  ...
  Widget _buildDot({required Offset begin, required Offset end, required Interval interval}) =>
      Transform.translate(
